...
This repository is a React 19 and TypeScript dashboard built with Vite, with Node.js ESM scripts for data processing.

## Repository-Wide Conventions

- Keep user-facing text and game-domain labels in French.
