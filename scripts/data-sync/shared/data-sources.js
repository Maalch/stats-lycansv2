...
export const DATA_SOURCES = {
  main: {
    name: 'Main Team',
    outputDir: 'data',
  gameFilter: (gameId) => gameId.startsWith('Ponce-') || gameId.startsWith('Tsuna-') || gameId.startsWith('khalen-') || gameId.startsWith('Meetozila-'), // Ponce-, Tsuna-, Khalen-, and Meetozila- games
