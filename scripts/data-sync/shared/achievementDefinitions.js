...
export const ACHIEVEMENT_DEFINITIONS = [
  ...
  // ============================================================================
  {
    ...
    explanation: 'Remporter X victoires en camp Villageois',
    emoji: '🏘️',
    category: 'victories',
    evaluator: 'campWins',
  ...
  },
  {
    ...
    explanation: 'Remporter X victoires en camp Loup',
    emoji: '🐺',
    category: 'victories',
    evaluator: 'campWins',
  ...
  },
  {
    id: 'victories-solo',
    name: 'Loup Solitaire',
    description: 'Pas besoin d\'alliés pour gagner',
    explanation: 'Remporter X victoires en camp solo (Amoureux, Idiot du Village, Agent, etc.)',
    emoji: '🎯',
    category: 'victories',
    evaluator: 'soloWins',
    evaluatorParams: {},
  ...
  {
    id: 'last-wolf',
    name: 'Le seul survivant',
    description: 'Pas besoin des villageois ou de loup pour gagner... Vous seul survivez',
    explanation: 'Gagner une partie en étant l\'unique survivant et donc le dernier loup',
    emoji: '🏚️',
    category: 'victories',
  ...
  {
    id: 'fall-death',
    name: 'Tentative de saut raté',
    description: 'Bien que la touche saut n\'existe pas, certains ont tout de même chuté',
    explanation: 'Mourir de chute',
    emoji: '🪂',
    category: 'deaths',
  ...
  },
  {
    id: 'exploded',
    name: 'Boum !',
    description: 'C\'est pas la taille qui compte, c\'est l\'explosion',
    explanation: 'Mourir d\'une explosion (BOMB)',
    emoji: '💣',
    category: 'deaths',
    evaluator: 'deathByType',
  ...
  },
  {
    id: 'crushed',
    name: 'Écrasé·e',
    description: 'Regardez où vous mettez les pieds...',
    explanation: 'Mourir écrasé·e (CRUSHED)',
    emoji: '🪨',
    category: 'deaths',
    evaluator: 'deathByType',
  ...
  },
  {
    id: 'avenger-death',
    name: 'Mort vengée',
    description: 'Vous êtes un porte-malheur pour votre tueur',
    explanation: 'Avoir son tueur qui meurt le même jour dans la partie',
    emoji: '⚖️',
    category: 'deaths',
  ...
  },
  {
    ...
    name: 'Oups, mauvaise potion',
    description: 'Tué un villageois en étant villageois... La potion avait l\'air suspecte',
    explanation: 'Tuer un joueur de votre camp avec une potion assassin',
    emoji: '☠️',
    category: 'kills',
    evaluator: 'assassinPotionKills',
  ...
  {
    id: 'democrat',
    name: 'Démocrate Parfait',
    description: 'Chaque vote compte',
    explanation: 'En tant que Villageois, voter 5 fois de suite (dans une même partie) pour des Loups ou des Rôles solos',
    emoji: '🏛️',
    category: 'social',
