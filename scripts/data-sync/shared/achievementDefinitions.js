...
export const ACHIEVEMENT_DEFINITIONS = [
  ...
  },
  {
    ...
    explanation: 'Faire X parties en devinant le rôle de deux joueurs en étant Loup (Devin ou boule de cristal)',
    emoji: '🔮',
    category: 'loups',
  ...
  },
  {
    ...
    explanation: 'Deviner correctement X rôles en Loup (Devin ou boule de cristal)',
    emoji: '🔮✨',
    category: 'loups',
