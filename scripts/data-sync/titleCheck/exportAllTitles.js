...
const statNamesFr = {
  ...
  votingAccuracyVillageois: 'Précision de vote (Villageois)',
  votingAccuracyLoup: 'Précision de vote (Loup)',
  votingAccuracySolo: 'Précision de vote (Solo)',
