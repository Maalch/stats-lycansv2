 ...
 * @param {string|null} [power] - Optional power field for Villageois Élite roles
...
export function getPlayerCampFromRole(roleName, groupOptions, power = null) {
  ...
  if (roleName === 'Villageois Élite' || roleName === 'Chasseur' || roleName === 'Alchimiste' || 
      roleName === 'Protecteur' || roleName === 'Disciple' || roleName === 'Guetteur' || roleName === 'Purificateur') {
 ...
 * @param {string|null} [power] - Optional power for Villageois Élite roles
