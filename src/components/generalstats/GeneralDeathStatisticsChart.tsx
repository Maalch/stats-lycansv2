...
export function GeneralDeathStatisticsChart() {
  const { data: deathStats, isLoading, error } = useDeathStatisticsFromRaw();
  const [activeChart, setActiveChart] = useState<'timing' | 'types'>('timing');
  ...
  return (
    <FullscreenChart title="Statistiques Générales de Mort">
