...
export function TransformationZoneChart() {
  ...
  const { actionMetaStats } = useActionMetaStatsFromRaw();
  ...
  return (
    <div className="transformation-zone-container">
      ...
      <div className="lycans-graphiques-groupe">
        ...
        {/* ── Chart 4 : Impact du timing de première transformation ── */}
        {actionMetaStats && actionMetaStats.wolfTransformTiming.length > 0 && (
          <div className="lycans-graphique-section">
              ...
              <div style={{ height: 400 }}>
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <Bar dataKey="winRate" fill={lycansColors['Loup'] || wolfColor} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
        ...
        {/* ── Chart 5 : Impact du nombre de détransformations ── */}
        {actionMetaStats && actionMetaStats.wolfUntransformStats.length > 0 && (
          <div className="lycans-graphique-section">
        ...
        <div className="lycans-section-description" style={{ flex: '1 1 100%', marginTop: '1rem' }}>
          ...
          <p style={{ marginTop: '0.4rem' }}>
            <strong>Graphique 4 :</strong> Impact du moment (nuit) de la première transformation
            en loup sur le taux de victoire, toutes cartes confondues.
          </p>
          <p style={{ marginTop: '0.4rem' }}>
            <strong>Graphique 5 :</strong> Impact du nombre de détransformations d'un loup au
            cours d'une partie sur son taux de victoire, toutes cartes confondues.
          </p>
          <div
            style={{
              display: 'flex',
