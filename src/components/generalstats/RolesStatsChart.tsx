...
interface RoleStats {
  ...
  appearances: number;
  wins: number;
  winsWithoutRoleChange: number;
  gamesWithoutRoleChange: number;
  winRate: string;
...
/**
 * Compute role statistics for all players combined
 */
function computeAllPlayersRoleStats(gameData: GameLogEntry[]): RoleData | null {
...
export function RolesStatsChart() {
  ...
  return (
    <div className="lycans-camps-container">
      <h2>Statistiques Générales des Rôles et Pouvoirs</h2>
