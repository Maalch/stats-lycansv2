...
export function PlayerHistoryActions({ selectedPlayerName }: PlayerHistoryActionsProps) {
  ...
  const actionStatistics = useMemo<ActionStatistics>(() => {
    ...
    filteredGameData.forEach(game => {
      ...
      actions.forEach((action) => {
        ...
        // Only track our specified action types (Gadgets and Potions)
    ...
    return (
      <div className="donnees-manquantes">
        ...
        <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
          Les données d'actions (gadgets, potions) ne sont disponibles que pour les parties récentes.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="lycans-graphiques-groupe">
      {/* Summary Cards */}
      <div className="lycans-resume-conteneur" style={{ width: '100%', flexBasis: '100%' }}>
